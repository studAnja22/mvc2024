 ...
 */
final class Version20250809145850 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE choices (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, room INTEGER NOT NULL, choice VARCHAR(255) NOT NULL, require VARCHAR(50) DEFAULT NULL, gain VARCHAR(255) NOT NULL)
        SQL);
        $this->addSql(<<<'SQL'
    ...
    public function down(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE choices (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, room INTEGER NOT NULL, choice VARCHAR(255) NOT NULL, gain VARCHAR(50) NOT NULL, require VARCHAR(50) DEFAULT NULL)
        SQL);
        $this->addSql(<<<'SQL'
